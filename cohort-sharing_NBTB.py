...
def para_generator(filename, NB, TB):
...
if __name__ == '__main__':
	...
	#NB_list = [130, 150, 165, 180]
	#NB_list = [190, 195, 200, 205]
	#NB_list = [210, 220, 235, 250, 280]

	## design the NB_list according to different T's (to keep the ratio under that T reachable within the designed range)


	## T = 5, ratio = 0.05, so NB_{real} = 100
	#NB_list = [50, 60, 65, 70, 73, 76, 80, 83, 85, 88, 90, 92, 94, 96, 98, 100, 102, 105, 110, 115, 120, 125, 130, 140, 155, 175, 200, 225, 250, 275, 300]
	#NB_list = [50, 60, 65, 70, 73, 76, 80, 83]
	#NB_list = [85, 88, 90, 92, 94, 96, 98, 100]
	#NB_list = [102, 105, 110, 115, 120, 125, 130, 140]
	#NB_list = [155, 175, 200, 225, 250, 275, 300]
	...
	NB_list = [100, 150, 200, 240, 270, 300, 325, 345, 360]
	#NB_list = [370, 375, 380, 385, 390, 395, 398, 400, 402]
	#NB_list = [404, 406, 408, 410, 415, 420, 430, 440, 450]
	#NB_list = [465, 480, 500, 525, 550, 575, 600]
	...
	for NB in NB_list:
		for TB in TB_list:
			...
			file = open("statistic_NB" + str(NB) + "TB" + str(TB) + ".ibd", "w")
